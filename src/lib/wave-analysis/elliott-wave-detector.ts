...
class ElliottWaveDetector {
  private static instance: ElliottWaveDetector;

  private constructor() {}

  static getInstance(): ElliottWaveDetector {
    if (!ElliottWaveDetector.instance) {
      ElliottWaveDetector.instance = new ElliottWaveDetector();
    }
    return ElliottWaveDetector.instance;
  }
...
export const elliottWaveDetector = ElliottWaveDetector.getInstance();
